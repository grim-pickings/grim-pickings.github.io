<script>
	...
	$: stackableProp = stackable ? 'stackable' : '';
	...
	function numToString(num) {
		...
		switch (numVal) {
			...
			case 11:
			case 'eleven':
				return 'eleven column';
			case 12:
			case 'twelve':
				return 'twelve column';
			case 13:
			case 'thirteen':
				return 'thirteen column';
			case 14:
			case 'fourteen':
				return 'fourteen column';
			case 15:
			case 'fifteen':
				return 'fifteen column';
			case 16:
			case 'sixteen':
				return 'sixteen column';
			default:
				return '';
		}
	}
...
<div class="ui {stackableProp} {columnsProp} {alignProp} grid">
	<slot />
</div>
